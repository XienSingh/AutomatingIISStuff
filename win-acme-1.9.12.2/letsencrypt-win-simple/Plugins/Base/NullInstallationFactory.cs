...
namespace PKISharp.WACS.Plugins.Base
{
    ...
    internal class NullInstallationFactory : IInstallationPluginFactory, INull
    {
        ...
        void IInstallationPluginFactory.Aquire(ScheduledRenewal renewal, IOptionsService optionsService, IInputService inputService, RunLevel runLevel, int? siteID = null) { }
